...
public class DBUpdate {
    ...
    private static final String JDBC_CONNECTION = "jdbc:postgresql://localhost:5432/lesson_db";// "jdbc:postgresql://[場所(Domain)]:[ポート番号]/[DB名]"
    /** ・ユーザー名 */
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String SQL = "UPDATE TB_SHOHIN\n" +
            		"SET \n" +
            		"shohin_name = '商品20'\n" +
            		"WHERE TB_SHOHIN.shohin_id = '020'";
            // 問⑥ 上記のSQL文を実行するための文を記述しましょう。
            statement.executeUpdate(SQL); //SELCT以外はexecuteUpdate()
            //一覧表示
